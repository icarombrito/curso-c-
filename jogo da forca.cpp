...
void exibeStatus(string palavraComMascara, int tamanhoDaPalavra, int tentativasRestantes, string letrasJaArriscadas, string mensagem, string palavra){
...
int jogar(int numeroDeJogadores){
    ...
    while(palavra != palavraComMascara && maximoDeTentativas - tentativas > 0){
        ...
        exibeStatus(palavraComMascara, tamanhoDaPalavra, maximoDeTentativas - tentativas, letrasJaArriscadas, mensagem, palavra);
    ...
    if(palavra == palavraComMascara){
        ...
        limpaTela();
        cout << "ruim voce perdeu vencedor";
        cout << "\nDeseja reiniciar?";
        cout << "\n1-Sim";
        cout << "\n2-Nao";
        cin >> opcao;
        ...
        limpaTela();
        cout << "oba voce venceu e sarcasmo!";
        cout << "\nDeseja reiniciar?";
        cout << "\n1-Sim";
        cout << "\n2-Nao";
        cin >> opcao;
    ...
    while(opcao < 1 || opcao > 3){
        ...
        switch(opcao){
            ...
            case 3:
                ...
                limpaTela();
                cout << "jogue e tente vencer e se perder tente de novo";
                cout << "\n1 - Voltar";
                cout << "\n2 - Sair";
                cin >> opcao;
                if(opcao == 1){
